...
const Footer = () => {
  ...
  <div>
    ...
    <p className="link link-hover">Environment</p> 
    <p className="link link-hover">Food Quality</p> 
    <p className="link link-hover">Relax</p> 
    <p className="link link-hover">Healthy & Tasty</p>
  </div> 
  <div>
    <span className="footer-title">Chef</span> 
    <p className="link link-hover">About us</p> 
    <p className="link link-hover">Contact</p> 
    <p className="link link-hover">Food Blog</p> 
...
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <div className="items-center grid-flow-col">
    ...
    <p>Chef Garden Ltd. <br/>Providing healthy food since 2020</p>
  </div> 
